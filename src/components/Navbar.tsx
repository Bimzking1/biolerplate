        ...
        <div className='w-full md:flex items-center justify-between py-4 md:px-10 px-7'>
          ...
          >
            <div className='text-xl mt-6 md:items-center md:text-center md:gap-4 flex flex-col md:flex-row md:ml-8 md:my-0 font-semibold'>
              ...
              <a href="#component1" className='hover:bg-gray-200 md:hover:bg-gray-100 rounded-full py-2 px-4 md:px-4 mb-2 md:mb-0 text-gray-800 hover:text-blue-400 duration-500'>
                NAV2
              </a>
              ...
              <Link to="/other" className='hover:bg-gray-200 md:hover:bg-gray-100 rounded-full py-2 px-4 md:px-4 mb-2 md:mb-0 text-gray-800 hover:text-blue-400 duration-500'>
                OTHER
              </Link>
              {
                isLogin ?
          ...
          >
            <div className='text-xl mt-6 md:items-center md:text-center md:gap-4 flex flex-col md:flex-row md:ml-8 md:my-0 font-semibold'>
              ...
              <a href="#component1" className={`${navColor === 'transparent' ? 'text-[#F5F5F5]' : 'text-gray-800'} hover:bg-gray-200 md:hover:bg-gray-100 rounded-full py-2 px-4 md:px-4 mb-2 md:mb-0 hover:text-blue-400 duration-500`}>
                NAV2
              </a>
              <a href="#component2" className={`${navColor === 'transparent' ? 'text-[#F5F5F5]' : 'text-gray-800'} hover:bg-gray-200 md:hover:bg-gray-100 rounded-full py-2 px-4 md:px-4 mb-2 md:mb-0 hover:text-blue-400 duration-500`}>
                NAV3
              </a>
              <Link to="/other" className={`${navColor === 'transparent' ? 'text-[#F5F5F5]' : 'text-gray-800'} hover:bg-gray-200 md:hover:bg-gray-100 rounded-full py-2 px-4 md:px-4 mb-2 md:mb-0 hover:text-blue-400 duration-500`}>
                OTHER
              </Link>
              {
                isLogin ?
